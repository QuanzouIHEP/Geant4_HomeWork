...
// ********************************************************************
//
// $Id: HWDetectorConstruction.cc 94307 2015-11-11 13:42:46Z gcosmo $
//
/// \file HWDetectorConstruction.cc
/// \brief Implementation of the HWDetectorConstruction class
...
{  
  ...
  G4LogicalVolume* logicHead =                         
    new G4LogicalVolume(solidHead,            //its solid
                        ...
                        "Head");         //its name
   G4VisAttributes *HeadLogVis=new G4VisAttributes(G4Color(1.,1.,0.));
   logicHead->SetVisAttributes(HeadLogVis);
...
fHeadPV = new G4PVPlacement(0,                       //no rotation
  ...
  G4LogicalVolume* logicNeck =                         
    new G4LogicalVolume(solidNeck,         //its solid
                        ...
                        "Neck");           //its name
   G4VisAttributes *NeckLogVis=new G4VisAttributes(G4Color(1.,0.,0.));//red
   logicNeck->SetVisAttributes(NeckLogVis);
  ...
  G4LogicalVolume* logicChest =                         
    new G4LogicalVolume(solidChest,         //its solid
                        ...
                        "Chest");           //its name
   G4VisAttributes *ChestLogVis=new G4VisAttributes(G4Color(0,1.,0.));
   logicChest->SetVisAttributes(ChestLogVis);            
  ...
  G4LogicalVolume* logicLeg1 =                         
    new G4LogicalVolume(solidLeg1,         //its solid
                        ...
                        "Leg1");           //its name
    G4VisAttributes *Leg1_LogVis=new G4VisAttributes(G4Color(0.,0.,1.));//bule
   logicLeg1->SetVisAttributes(Leg1_LogVis);            
  ...
  G4LogicalVolume* logicLeg2 =                         
    new G4LogicalVolume(solidLeg2,         //its solid
                        leg_mat,          //its material
                        "Leg2");           //its name
  G4VisAttributes *Leg2_LogVis=new G4VisAttributes(G4Color(0.,0.,1.));
   logicLeg2->SetVisAttributes(Leg2_LogVis);                
  new G4PVPlacement(leg_rot,                       //no rotation
